...
angular.module('AniTheme')
    .controller('lunchedProcessInboxCtrl', function ($scope, $http, $translate, $state, $rootScope, $modal, $location, LunchedProcessService, bpmnService) {
        ...
        $scope.doJob = function (LunchedProcessId) {
            $state.go("process.do", {lunchedProcessId: LunchedProcessId});
        ...
        $scope.getLunchedProcessList = function () {
            LunchedProcessService.listLunchedProcess($scope.currentPage, $scope.searchInput, $scope.itemsPerPage, "Inbox").success(function (data) {
                $scope.data = data;
...
angular.module('AniTheme').controller('ModalLunchedProcessCreateInstanceCtrl', function ($scope, $modalInstance, $http, bpmnService, $translate, LunchedProcessService) {
    ...
    $scope.listBpmns = function (current) {
        bpmnService.listBpmns(1, 1, undefined, 99).success(function (data) {
