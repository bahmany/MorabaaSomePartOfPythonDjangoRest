...
angular.module('AniTheme')
    .controller('lunchedProcessMyDoneProcessCtrl', function ($scope, $http, $translate, $rootScope, $modal, $location, LunchedProcessService, bpmnService) {
        ...
        $scope.getLunchedProcessList = function () {
            LunchedProcessService.listLunchedProcess($scope.currentPage, $scope.searchInput, $scope.itemsPerPage, "MyDoneProcess").success(function (data) {
                $scope.data = data;
